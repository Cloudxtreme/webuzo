...
<ul>
	...
	<?php echo ($FUD_OPT_3 & 536870912 ? '<li><a href="index.php?t=page&amp;'._rsid.'" title="Pages"><img src="theme/default/images/pages.png" alt="" /> Pages</a></li>' : ''); ?>
	...
	'.(__fud_real_user__ ? '<li><a href="index.php?t=login&amp;'._rsid.'&amp;logout=1&amp;SQ='.$GLOBALS['sq'].'" title="Logout"><img src="theme/default/images/top_logout.png" alt="" /> Logout [ '.$usr->alias.' ]</a></li>' : '<li><a href="index.php?t=login&amp;'._rsid.'" title="Login"><img src="theme/default/images/top_login.png" alt="" /> Login</a></li>'); ?>
...
<div class="footer ac">
	...
	<b>::.</b>
	<p class="SmallText">Powered by: FUDforum <?php echo $GLOBALS['FORUM_VERSION']; ?>.<br />Copyright &copy;2001-2013 <a href="http://fudforum.org/">FUDforum Bulletin Board Software</a></p>
</div>
