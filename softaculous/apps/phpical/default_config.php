...
// Define some magic strings.
		...
		$this->allow_admin				= 'yes';			// Set to yes to allow the admin page - remember to change the default password if using 'internal' as the $this->auth_method			
		...
		$this->auth_internal_username	= '[[admin_username]]';			// Only used if $this->auth_method='internal'. The username for the administrator.
		$this->auth_internal_password	= '[[admin_pass]]';			// Only used if $this->auth_method='internal'. The password for the administrator.
