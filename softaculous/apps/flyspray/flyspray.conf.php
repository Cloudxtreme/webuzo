...
dbhost = "[[softdbhost]]"				; Name or IP of your database server
dbname = "[[softdb]]"					; The name of the database
dbuser = "[[softdbuser]]"				; The user to access the database
dbpass = "[[softdbpass]]"				; The password to go with that username above
dbprefix = "[[dbprefix]]"				; The prefix to the Flyspray tables
